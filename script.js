//comunicaçao com banco de ddados - NOSQL - JSON
...
fetch('dados.json').then(resposta => resposta.json()).then(banco => {
    ...
    document.getElementById('cliente4') .innerHTML = banco[4].cliente.cli501
    ...
    document.getElementById('cliente5') .innerHTML = banco[4].cliente.cli502
})